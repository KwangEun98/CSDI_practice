...
class CSDI_base(nn.Module):
    def __init__(self, target_dim, config, device, mode):
        super().__init__()
        self.device = device
        ...
        self.diffmodel = diff_CSDI(config_diff, input_dim, mode)
...
class CSDI_Physio(CSDI_base):
    def __init__(self, config, device, mode, target_dim=35):
        super(CSDI_Physio, self).__init__(target_dim, config, device, mode)
